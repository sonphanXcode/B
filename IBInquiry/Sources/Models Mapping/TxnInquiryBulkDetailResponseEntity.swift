//
//  TxnInquiryBulkDetailResponseEntity.swift
//  IBInquiry
//
...
/** Data */
public struct TxnInquiryBulkDetailResponseEntity: Codable, Responseable, JSONEncodable, Hashable {
...
extension TxnInquiryBulkDetailResponseEntity: Emptyable {
    public static var empty: TxnInquiryBulkDetailResponseEntity {
...
public extension TxnInquiryBulkDetailResponseDto {
    func toEntity() -> TxnInquiryBulkDetailResponseEntity {
        return TxnInquiryBulkDetailResponseEntity(
            id: self.id,
            status: self.status,
