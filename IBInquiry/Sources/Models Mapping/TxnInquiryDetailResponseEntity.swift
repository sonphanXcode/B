//
//  TxnInquiryDetailResponseEntity.swift
//  IBInquiry
//
...
/** Data */
public struct TxnInquiryDetailResponseEntity: Codable, Responseable, JSONEncodable, Hashable {
...
extension TxnInquiryDetailResponseEntity: Emptyable {
    public static var empty: TxnInquiryDetailResponseEntity {
...
extension TxnInquiryDetailResponseDto {
    public func toEntity() -> TxnInquiryDetailResponseEntity {
        return TxnInquiryDetailResponseEntity(
            id: self.id,
            status: self.status,
