//
//  MackerListInquiryItemView.swift
//  IBInquiry
//
...
struct MackerListInquiryItemView: SeletedableView {
    ...
    private var transPoppupMaker: some View {
        Button(action: {
            ...
            HStack {
                IBResourcesAsset.printOutline.swiftUIImage
                    .resizable()
                    .scaledToFill()
                    .frame(20, 20)
                    .padding(.trailing, 4)
                Text(IBResourcesStrings.inChungTu)
                    .styleTypography(.bodyM)
