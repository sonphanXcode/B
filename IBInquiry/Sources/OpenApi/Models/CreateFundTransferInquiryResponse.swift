//
// CreateFundTransferInquiryResponse.swift
//
...
/** Data */
public struct CreateFundTransferInquiryResponse: Codable, Responseable, JSONEncodable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        benCardno = container.decodeIfPresent(.benCardno)
...
extension CreateFundTransferInquiryResponse: Emptyable {
    public static var empty: CreateFundTransferInquiryResponse {
